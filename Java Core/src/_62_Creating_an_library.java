class library{
    String[] books;
    int no_of_books;
    library(){   //creating a constructor
    ...
    void showavailablebooks(){  //this is used to show available books
...
public class _62_Creating_an_library {
    public static void main(String[] args) {
        library centrallibrary=new library();
        centrallibrary.addbook("the almanck of naval ravikant");
        centrallibrary.addbook("think and grow rich");
        centrallibrary.addbook("do epic shit"); //we can add till 100 books
